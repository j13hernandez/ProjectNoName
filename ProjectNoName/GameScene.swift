...
class GameScene: SKScene, SKPhysicsContactDelegate
{
    ...
    override init(size: CGSize)
    {
        ...
        for platformPosition in platformPositions
        {
            ...
            let platformNode = createPlatform(position:CGPoint(x: CGFloat(patternX!),
                                                               y: CGFloat(patternY!)), ofType: .Normal)
    ...
    //When User touches screen, push player up
